...
describe('navigationConfig', () => {
  describe('NAV_ITEMS', () => {
    ...
    it('contains Portfolios as sixth item', () => {
      expect(NAV_ITEMS[5].path).toBe('/portfolios');
      expect(NAV_ITEMS[5].label).toBe('Portfolios');
    });
  ...
  describe('MORE_NAV_ITEMS', () => {
    it('contains three additional navigation items (Agents, Lists, Portfolios)', () => {
    ...
    it('includes Portfolios as third item', () => {
      expect(MORE_NAV_ITEMS[2].label).toBe('Portfolios');
      expect(MORE_NAV_ITEMS[2].path).toBe('/portfolios');
    });
  });
  ...
  describe('isMoreMenuActive', () => {
    ...
    it('returns true when on portfolios path', () => {
      expect(isMoreMenuActive('/portfolios')).toBe(true);
    });
  });
});
